...
import com.example.aveuglesourd.SignInActivity

import com.example.aveuglesourd.Util.FirestoreUtil
import com.example.aveuglesourd.Util.StorageUtil
import com.firebase.ui.auth.AuthUI
import kotlinx.android.synthetic.main.activity_splashsourd.view.*
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        view.apply {
            ...
            btn_save.setOnClickListener {
                ...
                Toast.makeText(activity, "Enregistré", Toast.LENGTH_LONG).show()
            }
...
//qualité d'image et format
            val outputStream = ByteArrayOutputStream()
            selectedImageBmp.compress(Bitmap.CompressFormat.JPEG, 90, outputStream)
            selectedImageBytes = outputStream.toByteArray()
//téléchargement l'image de profile
            Glide.with(this)
